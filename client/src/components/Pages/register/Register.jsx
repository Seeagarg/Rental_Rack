    ...
    if (signup.fullname.length <= 1) {
      ...
      if (res.data === "") {
        ...
        window.Email.send({
          ...
          ${otp} is the OTP to Register in Crew-Rental

          Thank you for your cooperation in helping us maintain a secure environment for all our users.
          
          
          Best regards,
          Crew Rental
          officialjobhunt@gmail.com
          ...
          if (signup.fullname.length <= 1) {
            ...
            if (res.data === "") {
              ...
              window.Email.send({
                ...
                Body: `${otp} is the OTP to Register in Crew-Rental `
              }).then(
                message => {
                  if (message !== "OK") {
  ...
  const handleOtp = async (e) => {
    ...
    if (res) {
      ...
      window.Email.send({
        ...
        To: forgetEmail,
        From: "officialjobhunt@gmail.com",
        Subject: "This is the otp to reset password for Crew Rental",
        Body:`<pre>
        Dear ,

        ${otp} is the OTP to Reset password in Crew-Rental
